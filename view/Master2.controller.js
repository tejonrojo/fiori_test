sap.ui.core.mvc.Controller.extend("net.holcim.la.crd1.view.Master2", {
	...
	onRoutePatternMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "net.holcim.la.crd1.view.Detail",
			targetViewType: "XML",
			transition: "slide"
		});
	},
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "net.holcim.la.crd1.view.NotFound",
			targetViewType: "XML"
		});
	},
