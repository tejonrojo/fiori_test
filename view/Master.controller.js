sap.ui.core.mvc.Controller.extend("net.holcim.la.crd1.view.Master", {
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "net.holcim.la.crd1.view.Master2",
			targetViewType: "XML"
		});
		...
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "net.holcim.la.crd1.view.Welcome",
			targetViewType: "XML"
		});
	},
